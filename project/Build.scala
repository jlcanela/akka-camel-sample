...
object Dependencies {
  ...
  val helloKernel = Seq(
    akkaKernel, akkaSlf4j, akkaCamel, logback, camelJetty, camelNetty
  )
}
...
object Dependency {
  ...
  val camelJetty = "org.apache.camel" % "camel-jetty" % "2.10.3"
  val camelNetty = "org.apache.camel" % "camel-netty" % "2.10.3"
}